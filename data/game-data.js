...
var GAME_DATA = {
          ...
          "conclusions": [
            {
              ...
              "npc_reaction": {
                ...
                "phase_2": { "dialogue": "那只音乐盒……是我女儿的。对，是我女儿寄存在我这里的。她怕弄丢，让我藏在那里。铁盒那么重是因为……因为里面加了厚铁皮防撞。对，运输的时候怕摔坏，加了一层铁皮。谢谢你，医生，我终于想起来了。" },
                "crt_effect": null,
    ...
    "trial_2": {
      ...
      "stages": {
        ...
        "stage_04": {
          ...
          "hidden_layer": "频段#{目标编号}#047_47.3MHz，每周二/五 22:00-23:00 活跃，关联设备：{搪瓷杯底发射器}",
          "hidden_layer_keywords": ["目标编号", "搪瓷杯底发射器"],
          ...
          "conclusions": [
            {
              ...
              "type": "false",
              "label": "叛军家属的联络名单",
              "recipe": { "required_keywords": ["项链中的隐藏物", "项链吊坠的暗层"], "result": "叛军家属的联络名单" },
              "npc_reaction": {
          ...
          "hidden_keyword_sources": [
            ...
            },
            {
              ...
              "trigger": {
                ...
                "stage": "stage_04",
                "unlocks": [
                  { "stage": "stage_04", "word": "目标编号", "was_noise": true },
                  { "stage": "stage_04", "word": "搪瓷杯底发射器", "was_noise": true }
                ]
              }
            }
          ]
    ...
    "trial_3": {
      ...
      "stages": {
        ...
        "stage_03": {
          ...
          "next_stage": "stage_04",
          "hint": "「医生……手术台和武器数据，这两个东西不该在一起，对吗？但如果它们真的在一起了……那意味着什么？」",
        ...
        "stage_04": {
          ...
          "hidden_layer": "受试者#019，第四轮{记忆剥离}准备中——检测到残留{协议}碎片于深层记忆皮层，建议加深提取深度",
          "hidden_layer_keywords": ["记忆剥离", "协议"],
          "hidden_layer_gated_by": "trial3_semantic",
          "hidden_layer_meta_card": "记忆碎片"
        },
          ...
          "conclusions": [
            ...
            },
            {
              ...
              "npc_reaction": {
                ...
                "final_dialogue": "协议……记忆剥离协议。第三轮术后。他们不是要武器密码——他们要的是我脑子里的武器设计知识。他们取走了，然后封进了协议里。倒数的数字不是自毁程序——是记忆擦除的倒计时。红色的光是校准光束——校准擦除的位置。医生……你到底是谁？你为什么会知道这些？你……你就是那个穿白袍的人吗？"
              }
            }
          ],
          "hidden_keyword_sources": [
  ...
  "semantic_contradictions": [
    {
      ...
      "reveal_text": "（记忆的裂缝深处，一段加密通讯记录浮现出来——）\n\n「第七号{死信箱}已激活，{交接点}坐标：废弃诊所地下冷冻室。物品内容：数据芯片（铅板屏蔽层）。伪装层：粉色音乐盒。」\n\n（死信箱？交接点？这些词不属于一个快递员的日常。它们从记忆深处被矛盾撕开了一道口子，涌了出来。）",
      "unlocks": [
        { "stage": "stage_03", "word": "死信箱", "was_noise": true },
        { "stage": "stage_03", "word": "交接点", "was_noise": true }
      ]
    },
    {
      ...
      "unlocks": [],
      "unlocks_hidden_layer": ["stage_03", "stage_04"]
    }
  ],
  ...
  "keyword_metadata": {
    ...
    "杯子底部的暗格": { "attributes": ["fact"], "card_type": "normal", "is_extractable": true },
    ...
    "项链中的隐藏物": { "attributes": ["fact", "sensory"], "card_type": "normal", "is_extractable": true },
    ...
    "搪瓷杯底发射器": { "attributes": ["fact", "locked"], "card_type": "hidden", "is_extractable": false },
    // ─── Trial 2: 真结论路径产物 ───
    ...
    "冰冷的金属装置": { "attributes": ["sensory", "conflict"], "card_type": "normal", "is_extractable": true },
