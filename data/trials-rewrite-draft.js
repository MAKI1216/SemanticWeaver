/**
 * 语义缝合师 (Semantic Weaver) - Trial 1-4 对话文案成品版
 * 重写者：温思语 | 日期：2026-06-18
 * 约束：保持所有关键词名称、extractable_words、required_submit、recipes、hidden结构不变
 * 仅替换 intro / dialogue / hint / outro 文本内容，并填充 conclusions[]
 */
